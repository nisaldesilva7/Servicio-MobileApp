      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Stack(
            children: <Widget>[
              Container(
                child: Center(child: Text("Services and repairs".toUpperCase(),style: GoogleFonts.montserrat(color: Colors.white, fontSize: 18 ),)),
                height: 55,
...
//do stuff with the result
                       ...
                       stream: Firestore.instance.collection("Services").where('Service_Types',arrayContains: String, isEqualTo: 'searchType').snapshots(),
